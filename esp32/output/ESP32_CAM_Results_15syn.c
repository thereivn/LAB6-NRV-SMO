...
void _output_ESP32_CAM_Results_function_initSynchronous(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
/* Update base-clock. */
void _output_ESP32_CAM_Results_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
  TRACE_PUSH
...
int _output_ESP32_CAM_Results_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  TRACE_PUSH
  int ret;
...
/* %v% = pre(%v%)*/
void _output_ESP32_CAM_Results_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
